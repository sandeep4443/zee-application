...
class MainPage extends React.Component {
  ...
  findMovies = (e) => {
    ...
    if (findValue !== "") {
      ...
      this.setState({ movieinfo: MoviesList.slice(0, 20) });
    }
  };
  ...
  render() {
    return (
      <div>
        ...
        <div>
              <input type="button" class="btn btn-info export" value="Next" onClick={() => this.logout()}/>
            </div>
        ...
        {this.state.moviesCount >= 0 && this.state.resultsFound && (
          <h3>{this.state.moviesCount} results found</h3>
        )}
